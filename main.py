...
from utils.color_space import rgb_to_oklch, oklch_to_rgb
import time
...
def main():
    ...
    lightness = oklch_image[..., 1]
    write_image("oklch_image.jpg", lightness*255)
    rgb_image = oklch_to_rgb(oklch_image)
